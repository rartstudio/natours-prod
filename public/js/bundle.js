...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom' //loc.coordinates is object we our loop in our data
...
var stripe = Stripe('pk_test_51I0f8fHgCBEcefPGHwrMnLgohxIkaNvYmiy4TP8dHwtERKAYRulj7HeKoSzoyVlJGgDzJBqmUcVIWPV2HXHcWwDB00m0QiyCXs');
...
var bookBtn = document.getElementById('book-tour'); //checking if id map exist
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); //using multipart form data
    ...
    console.log(form);
    (0, _updateSettings.updateSettings)(form, 'data'); //a normal way without image
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Processing...'; //accessing data from dataset
